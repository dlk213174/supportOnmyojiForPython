...
class ModeMulti():
    ...
    def __mitamaInviteeFirst(self):
        ...
        self.ctrl_0.waitImg(IMG_SCENE_ESC)
        self.ctrl_0.sceneClickLoseImg(LOC_FIGHT_PREPARE, IMG_FIGHT_ENTER)
        time.sleep(10)
    ...
    def __mitamaInviterFirst(self, friend_opt, times):
        ...
        self.ctrl_1.waitImg(IMG_SCENE_ESC)
        self.ctrl_1.sceneClickLoseImg(LOC_FIGHT_PREPARE, IMG_FIGHT_ENTER)
        time.sleep(10)
